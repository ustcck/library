...
describe('Component Tests', () => {
  describe('Publisher Management Component', () => {
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      // GIVEN
      publisherServiceStub.retrieve.reset();
      comp.previousPage = 1;
      ...
      // THEN
      expect(publisherServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(publisherServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(publisherServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});
