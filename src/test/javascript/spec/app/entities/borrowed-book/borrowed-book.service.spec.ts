...
import { BorrowedBook } from '@/shared/model/borrowed-book.model';
...
describe('Service Tests', () => {
  describe('BorrowedBook Service', () => {
    ...
    beforeEach(() => {
      service = new BorrowedBookService();
    ...
    describe('Service methods', () => {
      it('should find an element', async () => {
        const returnedFromService = Object.assign(
          {
            borrowDate: format(currentDate, DATE_FORMAT),
          },
          elemDefault
        );
      ...
      it('should not create a BorrowedBook', async () => {
      ...
      it('should not update a BorrowedBook', async () => {
      ...
      it('should not return a list of BorrowedBook', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a BorrowedBook', async () => {
