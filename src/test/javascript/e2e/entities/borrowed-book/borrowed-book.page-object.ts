...
export default class BorrowedBookComponentsPage extends AlertPage {
...
export class BorrowedBookDeleteDialog {
  ...
  title: ElementFinder = element(by.id('libraryApp.borrowedBook.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-borrowedBook'));
}
