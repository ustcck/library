...
export default class ClientComponentsPage extends AlertPage {
...
export class ClientDeleteDialog {
  ...
  title: ElementFinder = element(by.id('libraryApp.client.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-client'));
}
