...
export default class PublisherComponentsPage extends AlertPage {
...
export class PublisherDeleteDialog {
  ...
  title: ElementFinder = element(by.id('libraryApp.publisher.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-publisher'));
}
