...
import com.ustcck.library.service.AuthorService;
import com.ustcck.library.web.rest.errors.BadRequestAlertException;
import com.ustcck.library.service.dto.AuthorCriteria;
import com.ustcck.library.service.AuthorQueryService;
...
/**
 * REST controller for managing {@link com.ustcck.library.domain.Author}.
 */
@RestController
@RequestMapping("/api")
