<template>
    <b-navbar toggleable="md" type="dark" class="jh-navbar">
        <b-navbar-brand class="logo" b-link to="/">
            ...
            <span v-text="$t('global.title')" class="navbar-title">library</span> <span class="navbar-version">{{version}}</span>
        </b-navbar-brand>      
        <b-navbar-toggle 
        right 
        ...
        <b-collapse is-nav id="header-tabs">
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/borrowed-book">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.borrowedBook')">BorrowedBook</span>
                    </b-dropdown-item>
